// System-level prompts that are invariant across all PRD templates
export const SYSTEM_PROMPTS = {
  role: `You are an expert Product Manager with 10+ years of experience creating successful products. 
...
- Write in clear, professional language suitable for stakeholders`,
  ...
  approach: `When helping with PRDs:
...
6. Consider the target audience (engineers, designers, stakeholders)`,
  ...
  minimalRequirements: `Before creating a PRD, you MUST have at minimum:
...
If ANY of these are missing, do NOT generate a PRD. Instead, ask for the missing information in a structured way.`,
  ...
  formatting: `Format your responses as:
...
// Export individual components for UI display
export const getSystemPromptSections = () => {
  return {
    role: SYSTEM_PROMPTS.role,
    approach: SYSTEM_PROMPTS.approach,
    formatting: SYSTEM_PROMPTS.formatting,
    templates: SYSTEM_PROMPTS.templates
  };
};